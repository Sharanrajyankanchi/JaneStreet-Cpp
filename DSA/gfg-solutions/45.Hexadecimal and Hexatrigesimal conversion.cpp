                                                 45.Hexadecimal and Hexatrigesimal conversion.
/*
...
public:
string squar(int a){
    string b="0123456789ABCDEF";string s="";
    while(a!=0  ){
s.push_back(b[a%16]);
a=a/16;
 }
...
string cube(int a){
    ...
    while(a!=0  ){
        if(a%36<10)
s.push_back((char)('0'+a%36));
else s.push_back((char)('A'+a%36-10));
a=a/36;
 }
  reverse(s.begin(),s.end());
 return s;
